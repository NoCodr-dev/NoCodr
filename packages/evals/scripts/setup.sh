...
build_extension() {
  echo "🔨 Building the NoCodr extension..."
...
echo -n "🗄️ Syncing NoCodr evals database... "
...
read -p "💻 Do you want to build a new version of the NoCodr extension? [currently $current_version] (y/N): " build_extension
