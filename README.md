<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=NoCodr-dev.nocodr"><img src="https://img.shields.io/visual-studio-marketplace/v/NoCodr-dev.nocodr.svg?label=VS%20Code%20Marketplace" alt="VS Code Marketplace"></a>
...
- 🤖 Latest AI models
- 🎁 API keys optional
- 💡 **Professional AI coding assistant with DevOps tools**

<p align="center">
  <img src="https://raw.githubusercontent.com/Kilo-Org/kilocode/refs/heads/main/kilo.gif" width="100%" />
</p>

- [VS Code Marketplace](https://nocodr.com/vscode-marketplace?utm_source=Readme) (download)
- [Official NoCodr.com Home page](https://nocodr.com) (learn more)
...
## How to get started with NoCodr

1. Install the NoCodr extension from the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=NoCodr-dev.nocodr).
...
3. Start coding with AI that adapts to your workflow. Watch our quick-start guide to see NoCodr in action:
...
We welcome contributions to NoCodr! Be the first to contribute and see your name here.

To get started, check out our [Contributing Guidelines](CONTRIBUTING.md) and [Code of Conduct](CODE_OF_CONDUCT.md).
