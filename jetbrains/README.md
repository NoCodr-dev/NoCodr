...
This directory contains the JetBrains plugin implementation for NoCodr, including both the IntelliJ plugin (Kotlin) and the Extension Host (Node.js/TypeScript).
